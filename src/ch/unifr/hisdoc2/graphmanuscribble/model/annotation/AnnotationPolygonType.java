...
public class AnnotationPolygonType{
    ...
    /**
     * Removes the annotationPolygon that is covering the LGC from the list.
     *
     * @param lGC - From which i want to delete the annotation
     */
    ...
    /**
     * First transfers all the graph sources to a given destination and then deletes
